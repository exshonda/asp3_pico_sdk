...
#  側に置き，チップ依存部（arch/arm_m_gcc/rp2350）とターゲット依存部
#  （target/rp2350-arm-s_pico_sdk）は本リポジトリ側に置く（ASP3_TARGET_DIR で供給）．
...
if (PICO_PLATFORM STREQUAL "rp2350-arm-s")
    set(ASP3_TARGET rp2350-arm-s_pico_sdk)
...
elseif (PICO_PLATFORM STREQUAL "rp2350-riscv")
    #  RISC-V（Hazard3）版は後続（asp3_core の raspberrypi_pico2_riscv_gcc を移植元にできる）
    message(FATAL_ERROR "not supported yet: ${PICO_PLATFORM} (RISC-V/Hazard3 is a follow-up)")
else()
...
function(asp3_set_pico_sdk_options TARGET)
  #  ASP3 が NVIC を掌握するため，SDKのベクタ/IRQ優先度初期化を抑止する
